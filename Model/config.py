...
parser.add_argument("--checkpoint_path", type=str, help="model weight file",
                    dest="checkpoint_path", default="/storage/caoxiaoling/voxel+residuals/check/112000.pth")
